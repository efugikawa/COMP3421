...
outfile = open("agents_data.txt", "w")
...
outfile = open("tickets_data.txt", "w")
...
outfile = open("customers_data.txt", "w")
...
outfile = open("handles_data.txt", "w")
for i in range(numTickets):
...
outfile = open("worksat_data.txt", "w")
for i in range(numCustomers):
...
outfile = open("manages_data.txt", "w")
for i in range(numCompanies):
